...
/// Concrete board drivers are supplied by plugin assemblies via <see cref="Register"/>.
/// </summary>
public static class DriverFactory
{
    ...
    /// <summary>Snapshot of registered driver type keys.</summary>
    public static IReadOnlyCollection<string> RegisteredTypes
    {
        get
        {
            return Factories.Keys.OrderBy(k => k, StringComparer.OrdinalIgnoreCase).ToArray();
        }
    }
