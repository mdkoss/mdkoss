...
using MDKOSS.Host;
using MDKOSS.Sample.Tools.Machine;
using System.Windows.Forms;

namespace MDKOSS.Sample.Tools;

/// <summary>
/// CEF host for device-component debug. Instances and the start page come from
/// the first JSON in <c>configs/</c>; the tools hub is registered here.
/// </summary>
internal static class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        MdkExtensionHost.Register(new ToolsSampleExtension());
    ...
    private static void RunCefDesktop(string settingPath)
    {
        ...
        AppLog.Info($"MDKOSS.Sample.Tools starting (version: {version})================================================");

        ApplicationConfiguration.Initialize();

        const string appTitle = "MDKOSS Sample — 设备组件调试";
