...
internal static class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        MdkExtensionHost.Register(new ModbusDriverSampleExtension());
    ...
    private static void RunCefDesktop(string settingPath)
    {
        ...
        AppLog.Info($"MDKOSS.Sample.Modbus starting (version: {version})================================================");

        ApplicationConfiguration.Initialize();

        const string appTitle = "MDKOSS Sample — Modbus IDriver";
