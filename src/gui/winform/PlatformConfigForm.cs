...
public sealed class PlatformConfigForm : Form
{
    ...
    public PlatformConfigForm(string settingPath)
    {
        _settingPath = settingPath;
        Text = "Platform Config Manager";
        Width = 900;
        Height = 600;
    ...
    private void LoadRows()
    {
        ...
        _binding.DataSource = setting.Devices
            .Where(d => d.Type.Equals("platform", StringComparison.OrdinalIgnoreCase))
    ...
    {
        var setting = ConfigFormHelpers.LoadSetting(_settingPath);
        var keep = setting.Devices.Where(d => !d.Type.Equals("platform", StringComparison.OrdinalIgnoreCase)).ToList();
        ...
        MessageBox.Show(this, "Platform config saved.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
