...
完整示例见 `src/MDKOSS.Sample/configs/sample.setting.json`、`src/MDKOSS.Sample.DieBonder/configs/sample.setting.json`、`src/MDKOSS.Sample.Dispenser/configs/sample.setting.json`、`src/MDKOSS.Sample.Pnp/configs/sample.setting.json`。
